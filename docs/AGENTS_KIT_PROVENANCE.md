...
| ScrollButton               | —                                                                                          | fork's existing `app/src/components/ScrollToBottomButton.tsx`                  | slides up from the composer / slides straight down under it                                                      | Native equivalent kept                                                                                                      |
