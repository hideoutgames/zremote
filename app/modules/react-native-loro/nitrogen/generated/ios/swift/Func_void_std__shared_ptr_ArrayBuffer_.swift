...
/**
 * Wraps a Swift `(_ update: ArrayBuffer) -> Void` as a class.
...
public final class Func_void_std__shared_ptr_ArrayBuffer_ {
  ...
  private let closure: (_ update: ArrayBuffer) -> Void

  public init(_ closure: @escaping (_ update: ArrayBuffer) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(update: ArrayBuffer) -> Void {
    self.closure(update)
  }
