...
// splits into reserved Sidebar | Detail | Inspector columns so the transcript
...
export function AdaptiveShell({
  ...
  // Reserved-column collapse: 0 = column width, 1 = width 0.
  ...
  return (
    <View style={[styles.row, { backgroundColor: theme.background }]}>
      ...
      >
        <View style={[styles.sidebarInner, { width: layout.sidebarWidth }]}>
      ...
      {layout.inspectorVisible ? (
        <View style={[styles.inspectorColumn, { width: layout.inspectorWidth }]}>
          <Glass style={styles.inspectorGlass}>
            <View style={[styles.tabs, { borderBottomColor: theme.border }]}>
              {(['changes', 'files', 'terminal', 'history'] as const).map(
                tab => {
                  const label =
                    tab === 'changes'
                      ? t('inspector.changes')
                    ...
                    >
                      <Text
                        ...
                        style={[
                          ...
                          {
                            color:
                              inspectorTab === tab ? theme.accent : theme.text,
                          },
                        ]}
                      >
                        {label}
